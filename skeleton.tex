...
\mode<presentation>
{
  ...
  \usetheme{Madrid}
  \usecolortheme[RGB={16,99,166}]{structure}
}

\title{Kostra přednášky}
\author{Ondřej Caletka}
\institute[CESNET, z. s. p. o.]{\includegraphics[width=4cm]{fig/cesnet-logo}}
\logo{\includegraphics[width=1.5cm]{fig/cesnet-logo}}
...
\begin{frame}
 \begin{center}
  ...
  \begin{figure}
   \includegraphics[width=8cm]{fig/cesnet-logo}
  \end{figure}
 \end{center}
\end{frame}
}
